    ...
    <div data-testid="home-page">
      ...
      <section className="hero-section" data-testid="hero-section">
        ...
        <div className="hero-content max-w-7xl mx-auto pt-32">
          ...
          >
            <span className="inline-block text-neon-gold text-xs md:text-sm uppercase tracking-[0.3em] mb-4">
      ...
      {/* Events Grid */}
      {events.length > 1 && (
        <section className="py-20 px-4 bg-black/40" data-testid="events-grid-section">
          <div className="max-w-7xl mx-auto">
      ...
      {testimonials.length > 0 && (
        <section className="py-20 px-4 bg-black/40" data-testid="testimonials-section">
          <div className="max-w-7xl mx-auto">
            <motion.div
              className="text-center mb-12"
              initial={{ opacity: 0, y: 20 }}
