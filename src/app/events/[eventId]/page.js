      ...
      <div className="relative h-[50vh] md:h-[70vh] bg-black overflow-hidden flex items-center justify-center">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 md:p-12">
          <div className="max-w-7xl mx-auto">
            ...
            >
              <span className="inline-block px-3 py-1 bg-neon-red text-white text-xs uppercase tracking-wider rounded-full mb-4">
                {event.category}
              </span>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            >
              <div className="flex items-center gap-3 mb-4">
                <Clock className="text-neon-red" size={24} />
            ...
            >
              ...
              <div className="grid md:grid-cols-3 gap-4">
                {/* Standard Entry */}
                <div className="bg-[#0F0F13] rounded-xl p-6 border border-white/10 hover:border-neon-red/50 transition-colors">
                  <div className="flex items-center gap-3 mb-4">
                ...
                {event.has_table_promo && (
                  <div className="bg-[#0F0F13] rounded-xl p-6 border border-neon-red/30 hover:border-neon-red transition-colors">
                    ...
                    <Link
                      href={`/tables/promo?event=${event.id}`}
                      className="btn-primary w-full py-3 rounded-lg text-center block"
                ...
                {/* Table VIP */}
                {event.has_table_vip && (
                  <div className="bg-gradient-to-br from-[#0F0F13] to-[#1A1A24] rounded-xl p-6 border border-neon-gold/50 hover:border-neon-gold transition-colors relative overflow-hidden">
                    ...
                    <div className="flex items-center gap-3 mb-4">
                      <div className="w-12 h-12 rounded-full bg-neon-gold/20 flex items-center justify-center">
                        <Crown className="text-neon-gold" size={24} />
                      </div>
                      <div>
                    ...
                    <p className="text-2xl font-bold text-neon-gold mb-4">
                    ...
                    <Link
                      href={`/tables/vip?event=${event.id}`}
                      className="w-full py-3 rounded-lg text-center block bg-neon-gold text-black font-bold hover:bg-[#E5C048] transition-colors"
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-neon-red">{event.available_spots}</span>
                </div>
                ...
                {event.has_table_vip && (
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-neon-gold">{event.table_vip_available || 0}</span>
                  </div>
                )}
              </div>
